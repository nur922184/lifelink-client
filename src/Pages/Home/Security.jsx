            ...
            <section className="py-16 dark:bg-gray-900 dark:text-white">
                <div className="max-w-6xl mx-auto px-6 text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-gray-800 p-6 rounded-2xl shadow-xl text-center hover:scale-105 transition-transform duration-300">
                            <FaShieldAlt className="text-purple-400 text-5xl mx-auto mb-4" />
                            <h3 className="text-2xl text-purple-300 font-semibold mb-2">Data Protection</h3>
                        ...
                        <div className="bg-gray-800 p-6 rounded-2xl shadow-xl text-center hover:scale-105 transition-transform duration-300">
                            ...
                            <h3 className="text-2xl text-purple-300 font-semibold mb-2">Secure Messaging</h3>
                            <p className="text-gray-300">All messages and calls are end-to-end encrypted for privacy.</p>
                        </div>
                        <div className="bg-gray-800 p-6 rounded-2xl shadow-xl text-center hover:scale-105 transition-transform duration-300">
                            <FaShieldAlt className="text-purple-400 text-5xl mx-auto mb-4" />
                            <h3 className="text-2xl text-purple-300 font-semibold mb-2">Verified Profiles</h3>
